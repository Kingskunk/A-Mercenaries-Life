...
- **Always visible (ambient framing, no specific secret):** "the Grey Marches" as a place name, "a contested... frontier borderland," the Iron Carrion's "answer to no crown" motto, the name "the Broken Crown War" as the company's founding event.
- **Locked until unlocked (`codex_meridian_empire`):** what the Broken Crown War actually was, that the Marches are nominally imperial territory, why no one enforces law here, and the real shape of Vane's backstory. Currently set `true` automatically only for the **Disgraced Scion** origin (their family held their lands *of* the old imperial patent — they'd know this as a basic fact of their own disinherited birthright). Ashbrook Survivor and Port Valen Outlaw start with this locked; they have no natural reason to know imperial administrative history yet.
...
- The Broken Crown War deliberately has no place-name tied to it (fixed from an earlier draft that called it "the Salt Marches War," which read as a third, confusingly-similar "Marches" alongside the Grey Marches and a since-removed "Western Marches rebellion" reference). If the war's actual location ever matters to a scene, name it fresh at that point — don't let it collide with "Marches" again.
