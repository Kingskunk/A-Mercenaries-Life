...
**Cadence changed again: once per day, not every 2 days**, and success pay is now a flat 12 copper (partial failure 4) — matches your framing of "roughly twice wading, doable daily." Wading's payout was corrected back to 6 copper (2 scrap) after an earlier mistake on my part bumped it to 9 without you asking for that — with wading correctly at 6, 12 is exactly double, so the original 12 figure was right all along and needed no change.

At 12 copper/day for 6 hours (2 copper/hour) against wading's 6 copper/day for 5 hours (1.2 copper/hour), courier is now a full daily option rather than an every-other-day one — a player doing both every day spends 11 of their 14 working hours on the two of them combined, which fits the "2 jobs = most of your day" intent directly rather than needing Crane Three or a cross-district trip to get there.
